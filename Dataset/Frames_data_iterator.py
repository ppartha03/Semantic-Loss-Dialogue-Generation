    ...
    def __getitem__(self, start_ind):
        ...
        def getGraph(edge_dict):
            ...
            for k,v in edge_dict.items():
                ...
                edge = [self.Edges[k.strip().lower()] if k.strip().lower() in self.Edges else 2]
            ...
            if 'log' in D:
                ...
                for k,_ in logs.items():
                    ...
                    if len(text) < max_length-3:
                        ...
                        indices = [self.Vocab[text[x].strip()] if text[x] in self.Vocab else 2 for x in range(max_length-3)]
